...
public class EnchantmentSplitterInventoryInputs implements IInventory {
    ...
    public EnchantmentSplitterInventoryInputs(String title, boolean customName, int slotCount) {
    ...
    public EnchantmentSplitterInventoryInputs(ITextComponent title, int slotCount) {
    ...
    public void setInventorySlotContents(int index, ItemStack stack) {
        setInventorySlotContents(true, index, stack);
    }

    public void setInventorySlotContents(boolean markDirty, int index, ItemStack stack) {
