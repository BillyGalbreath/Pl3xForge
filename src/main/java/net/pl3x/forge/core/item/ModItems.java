...
import net.pl3x.forge.core.item.tool.ItemAxe;
import net.pl3x.forge.core.item.tool.ItemHoe;
import net.pl3x.forge.core.item.tool.ItemPickaxe;
import net.pl3x.forge.core.item.tool.ItemShovel;
import net.pl3x.forge.core.item.tool.ItemSword;
...
public class ModItems {
    ...
    public static final net.minecraft.item.ItemArmor.ArmorMaterial emeraldArmorMaterial =
            EnumHelper.addArmorMaterial("EMERALD", Pl3xCore.modId + ":emerald",
    ...
    public static final net.minecraft.item.ItemArmor.ArmorMaterial rubyArmorMaterial =
            EnumHelper.addArmorMaterial("RUBY", Pl3xCore.modId + ":ruby",
