...
public class ItemClaimToolVisual extends ItemClaimTool {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        if (player.isSneaking()) {
            player.inventory.setInventorySlotContents(player.inventory.currentItem, ModItems.CLAIM_TOOL_CREATE.getDefaultInstance());
        }
