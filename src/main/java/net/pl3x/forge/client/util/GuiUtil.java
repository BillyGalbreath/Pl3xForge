...
public class GuiUtil {
    public static final ResourceLocation GUI_BG = new ResourceLocation(Pl3xForgeClient.modId, "textures/gui/gui_bg.png");
    public static final ResourceLocation GUI_ELEMENTS = new ResourceLocation(Pl3xForgeClient.modId, "textures/gui/gui_elements.png");

    public static final ResourceLocation COIN = new ResourceLocation(Pl3xForgeClient.modId, "textures/items/coin.png");
