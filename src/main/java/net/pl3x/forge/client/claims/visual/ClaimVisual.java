package net.pl3x.forge.client.claims.visual;
...
import net.pl3x.forge.client.util.Color;
import net.pl3x.forge.client.util.GL;
...
public class ClaimVisual {
    ...
    private void setFrame() {
        outlineColor = new Color(ModConfig.claimVisuals.outlineColor);
        gridColor = new Color(ModConfig.claimVisuals.gridColor);
        thickness = ModConfig.claimVisuals.thickness;
    }

    public void render(float partialTicks) {
        if (ModConfig.claimVisuals.renderBehind) {
