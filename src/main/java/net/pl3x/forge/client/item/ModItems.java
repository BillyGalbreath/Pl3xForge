...
import net.pl3x.forge.client.item.tool.ItemAxe;
import net.pl3x.forge.client.item.tool.ItemHoe;
import net.pl3x.forge.client.item.tool.ItemPickaxe;
import net.pl3x.forge.client.item.tool.ItemShovel;
import net.pl3x.forge.client.item.tool.ItemSword;
