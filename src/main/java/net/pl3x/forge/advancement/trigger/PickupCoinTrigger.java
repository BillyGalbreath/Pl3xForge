...
public class PickupCoinTrigger implements ICriterionTrigger<PickupCoinTrigger.Instance> {
    private static final ResourceLocation ID = new ResourceLocation(Pl3x.modId, "pickup_coin");
